...
//UTIL to auto collect templates
util.collect_templates = function( selector ) {
	var sel = selector || 'script[type="text/x-js-template"]';
	var $templatesInHtml = $( sel );
